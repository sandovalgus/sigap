...
class FunctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create function" do
    assert_difference('Function.count') do
      post functions_url, params: { function: { department_id: @function.department_id, name: @function.name } }
    end
  ...
  test "should update function" do
    patch function_url(@function), params: { function: { department_id: @function.department_id, name: @function.name } }
